<?php
  ...
  if (mysqli_num_rows($run)) {
    ...
    */
    ...
    $sql = "SELECT composite_grp_act.ac_id, activity.ac_no, activity.ac_name, activity.position, users.user_id, users.name 
            FROM composite_grp_act 
            LEFT OUTER JOIN activity 
            ON composite_grp_act.ac_id = activity.ac_id 
            LEFT OUTER JOIN groups 
            ON composite_grp_act.group_id = groups.group_id 
            LEFT OUTER JOIN users ON groups.group_id = users.group_id 
            WHERE composite_grp_act.group_id = $group_id
